        ...
        <div>
          ...
          <div className="mt-16">
            ...
            <div className="mt-10 space-y-6 body-text">
              {
                blog.comments.map(comment=><div key={comment.id} className="max-w-[722px] flex items-center  gap-4 border-b pb-10">
                    <div className="">
                        <Image src={comment.avatar} alt="avatar" width={86} height={86} className="size-21.5 object-cover"/>
                    </div>
                    <div className="flex-1">
                        <h6 className="heading-6">{comment.name}</h6>
